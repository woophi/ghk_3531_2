  ...
  return (
    <>
      <div className={appSt.container}>
        ...
        <div className={appSt.grid}>
          <a
            ...
            onClick={() => window.gtag('event', 'Alfapotok_3531_2')}
          >
            <div>
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'DFA_2')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ЦФА
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'Fonds_2')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                Фонды
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'DU_2')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ДУ
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'IIS_2')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ИИС
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile block view="primary" href="alfabank://investments" onClick={() => window.gtag('event', 'Vitrina_2')}>
          Витрина инвестиций
        </ButtonMobile>
      </div>
      <BottomSheet
        ...
        onClose={() => {
          if (selectedItem === 'isz') {
            window.gtag('event', 'ISG_Exit_2');
          } else {
            window.gtag('event', 'NSG_Exit_2');
          }
          setOpenBs(false);
        }}
        hasCloser
        ...
        actionButton={
          <ButtonMobile
            ...
            onClick={() => {
              if (selectedItem === 'isz') {
                window.gtag('event', 'ISG_More_info_2');
              } else {
                window.gtag('event', 'NSG_More_info_2');
              }
            }}
          >
            Подробнее на сайте
      ...
      >
        <div className={appSt.containerBS}>
          ...
          <Typography.Title
            ...
            onClick={() => {
              if (selectedItem === 'isz') {
                window.gtag('event', 'ISG_Mobile_2');
              } else {
                window.gtag('event', 'NSG_Mobile_2');
              }
